                    ...
                    <div class="card-body p-5">
                        <div class="row">
                            <div class="col-lg-4 px-5 text-center" style="border-right: 1px solid #999">
                                <img src="{{ asset('img/no-profile.jpg') }}" id="image-preview" class="img-fluid rounded-circle img-thumbnail" width="200" alt="">
                                <div class="">
                                ...
                                <form action="" method="post" id="profile_form">
                                    ...
                                    <div class="row">
                                        <div class="col-lg">
                                            ...
                                            <select name="gener" id="gender" class="form-select rounded-0">
